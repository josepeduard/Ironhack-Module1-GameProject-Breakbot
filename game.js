...
class Game{
   ...
   startLoop (){
       ...
       this.enemies.push(new Enemy(this.canvas, 100, 50));
       this.enemies.push(new Enemy(this.canvas, 200, 75));
       this.enemies.push(new Enemy(this.canvas, 300, 100));
       this.enemies.push(new Enemy(this.canvas, 400, 125));
       this.enemies.push(new Enemy(this.canvas, 500, 150));
       this.enemies.push(new Enemy(this.canvas, 600, 175));
       this.enemies.push(new Enemy(this.canvas, 700, 200));
       this.enemies.push(new Enemy(this.canvas, 800, 225));
       this.enemies.push(new Enemy(this.canvas, 900, 250));
